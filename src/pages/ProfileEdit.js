...
useEffect(async () => {
      await getDoc(doc(db, "Profile", auth.currentUser.uid)).then(async(docSnap) => {
        if (docSnap.exists()) {
          ...
          await getDownloadURL(ref(storage, data.Picture_id)).then((url) => {
...
const handleImage = async(event) => {
  await console.log(event.target.files[0]);
  await setImage(event.target.files[0]);
    console.log("hello");
    // if(await image.size > 5000000){
    ...
    var filename = uuidv4();
    const storage = await getStorage();
    const imageRef = await ref(storage, filename);
    ...
    <Flex mt = "30px" ml = "-230px" >
     <Image id = "myimg" h = "200px" w = "200px" bg = "transparent" mt = "80px" mr = "80px" borderRadius="full"/>
		<Box rounded={'xl'} mt = "38" w = "680px" h = "600"> 
			<Heading mt = "-5px" align = "center" color = "primary.2350" > Profile Update </Heading>
            ...
            fontWeight = "bold"
		      ...
		      {props => (
		        <HStack >
              <EditablePreview textAlign = "center" ml = "3" mt = "1" minW = "423" maxW= "423" minH = "9" maxH = "9"/>
              <EditableInput textAlign = "center" minW = "423" maxW= "423" minH = "9" maxH = "9"/>
        ...
        <InputGroup mt = "10" ml = "20px"  >
          ...
          {props => (
            <HStack  >
              <EditablePreview textAlign = "center" ml = "3" mt = "1" minW = "104px" maxW= "104px" minH = "9" maxH = "9"/>
              <EditableInput variant= "filled" textAlign = "center" minW = "104px" maxW= "104px" minH = "9" maxH = "9"/>
              <EditableControls {...props} />
            </HStack>
          )}
        </Editable>
        ...
        <InputGroup  mt = "10" >
          ...
          {props => (
            <HStack >
              <EditablePreview textAlign = "center" ml = "3" mt = "1" minW = "104px" maxW = "104px" minH = "9" maxH = "9"/>
              <EditableInput textAlign = "center" minW = "104px" maxW= "104px" minH = "9" maxH = "9"/>
              <EditableControls {...props} />
            </HStack>
          )}
        </Editable>
        ...
        <InputGroup mt = "10" ml = "20px">
          ...
          {props => (
            <HStack >
              <EditablePreview textAlign = "center" ml = "3" mt = "1" minW = "385" maxW= "385" minH = "9" maxH = "9"/>
              <EditableInput textAlign = "center" ml = "3" minW = "385" maxW= "385" minH = "9" maxH = "9"/>
              <InputRightAddon fontSize = "md" fontWeight = "extrabold" w = "30px"  h = "30px"  > lbs</InputRightAddon>
              <EditableControls {...props}/>
            </HStack>
          )}
        </Editable>
        ...
        <InputGroup w = "100px" mt = "10" ml = "20px">
          ...
          <RadioGroup color = "primary.2350" fontWeight = "bold" mt = "10px" value= {input.gender} >
           <HStack spacing="73px" >
              ...
              <Radio value="Other" size = 'md' onChange={(event) => handleChange("gender", event.target.value)}>Other</Radio>
        ...
        <FormControl id="email">
            ...
            <FormLabel pt = "12.5px" pl = "18px"ml = "250px" mt= "50px" borderRadius=  "10px" w = "200px" h ="50px" htmlFor="getFile" class="button" bg = "primary.3200" color  = "primary.150" fontWeight = "bold" fontSize = "16">Upload Profile Picture</FormLabel>
            <Input
              border = "transparent"
              type = "file" 
