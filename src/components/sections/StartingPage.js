  ...
  return (
    ...
    <HStack spacing = "30px"> 
      ...
      <Box w = "300px" bg = "transparent">
        <Image src = {run} backgroundColor = "transparent" w = "200px" h = "200px" />
      </Box>
      <Box w = {{ base: "80%", sm: "60%", md: "50%" }} mb = {{ base: 12, md: 0 }}>
        <Image src = {girl1} backgroundColor = "transparent" h = "200px" w = "170px" />
      </Box>
    </HStack>
    <HStack spacing = "30px">
      <Spacer />
      <Spacer />
      <Box w = "300px">
        <Image src = {guy1} backgroundColor = "transparent" h = "200px" w = "170px"/>
      </Box>
      <Box w = "300px" bg = "transparent">
          <Image src = {weights} backgroundColor = "transparent" w = "200px" h = "200px" />
      </Box>
    </HStack>
    <Spacer />
    </Stack>
...
StartingPage.defaultProps = {
  ...
  subtitle:
    "Connect with friends and track your health",
